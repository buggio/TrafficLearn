...
/**
 * Created by Phet on 11/09/2016.
 */
public class TrafficAdapter extends BaseAdapter{

    private Context context;
    private String[] titltStrings, defailStrings;
    private int[] ints;
    ...
    public TrafficAdapter(Context context,
        ...
        this.titltStrings = titleStrings;
        this.defailStrings = detailStrings;
        this.ints = ints;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        // Show View
        titleTextView.setText(titltStrings[i]);
        detailTextView.setText(defailStrings[i]);
